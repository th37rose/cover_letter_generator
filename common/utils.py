...
QUERIES = {
    ...
    'Simplest Template - Technical Solution': f"""
        ...
        Please generate its greetings and farewells randomly with {EMOTIONS} at the start and the end of greetings in the cover letter every time. Please do that step by step!
    """,
    'General Template - Skill set & Code': f"""
        Please analysis ths job description step by step and give me real technical cover letter following the cover letter template I shared with you, with work experience and skill set. 
